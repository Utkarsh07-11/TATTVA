      ...
      <div className="bg-[#080b10] border border-technical p-4 sm:p-5 rounded flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-4 sm:border-l sm:border-technical sm:pl-5">
          <div>
            ...
            <div className="text-xl sm:text-2xl font-bold font-sans text-rose-400">
              -{primaryDriver.raw_impact_tonnes} t
            </div>
          </div>
          <button
            onClick={() => setShowDetails(!showDetails)}
            className="px-3 py-1.5 rounded bg-[#101622] hover:bg-[#182233] border border-technical text-slate-200 text-xs font-sans flex items-center gap-1.5 transition-colors cursor-pointer self-start sm:self-auto ml-auto"
          >
      ...
      <div className="panel p-4 space-y-4">
            ...
            <div key={c.factor} className="bg-[#080b10] p-2.5 rounded border border-technical">
              <div className="flex items-center justify-between text-xs mb-1.5 font-sans">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span className="font-sans font-bold text-white w-10 text-right">
                    {c.contribution_pct}%
                  </span>
                </div>
              </div>
        ...
        {narrative && (
          <div className="bg-[#080b10] border border-technical rounded p-3 text-xs text-slate-300 font-sans leading-relaxed">
            <div className="font-sans text-slate-400 mb-1 text-xs uppercase tracking-wider font-semibold">
        ...
        <div className="bg-[#0e0c08] border border-amber-900/40 rounded p-2.5 text-xs text-amber-300/90 flex items-start gap-2 font-sans">
